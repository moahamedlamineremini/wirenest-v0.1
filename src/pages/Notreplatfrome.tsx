      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-full md:w-1/2">
            <div className="flex items-center gap-4 mb-4">
              <img src="/src/img/1.png" alt="Numéro 1" className="w-16 md:w-24 h-16 md:h-24" />
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/2 order-2 md:order-1">
            <div className="flex items-center gap-4 mb-4">
              <img src="/src/img/2.png" alt="Numéro 2" className="w-16 md:w-24 h-16 md:h-24" />
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-full md:w-1/2">
            <div className="flex items-center gap-4 mb-4">
              <img src="/src/img/3.png" alt="Numéro 3" className="w-16 md:w-24 h-16 md:h-24" />
